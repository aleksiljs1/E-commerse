  ...
  return (
    <div className="min-h-screen bg-[#0F1412] text-[#E8F5EE]">
      <div className="max-w-3xl mx-auto px-5 md:px-10 py-16">
        <h1 className="font-rajdhani text-3xl md:text-4xl font-bold text-[#E8F5EE] mb-2">Terms of Service</h1>
        <p className="text-[#A0B5A8] text-sm mb-10">Last updated: January 2026</p>

        <div className="space-y-8 text-[#A0B5A8] leading-relaxed">
          <section>
            <h2 className="text-[#E8F5EE] font-semibold text-lg mb-3">1. Service Description</h2>
            <p>
          ...
          <section>
            <h2 className="text-[#E8F5EE] font-semibold text-lg mb-3">2. Customer Responsibilities</h2>
          ...
          <section>
            <h2 className="text-[#E8F5EE] font-semibold text-lg mb-3">3. Payment</h2>
            <p>
          ...
          <section>
            <h2 className="text-[#E8F5EE] font-semibold text-lg mb-3">4. Warranty</h2>
            <p>
          ...
          <section>
            <h2 className="text-[#E8F5EE] font-semibold text-lg mb-3">5. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-[#E8F5EE] font-semibold text-lg mb-3">6. Changes to Terms</h2>
            <p>
